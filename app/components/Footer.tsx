...
export default function Footer() {
  ...
  return (
    <footer className="w-full max-w-md mt-10 mb-4 flex flex-col items-center gap-2">
      {/* Copyright line */}
      <p className="text-blue-900/60 text-xs tracking-wide">
        Jan Carlo M. Cardama &copy; {year}
      </p>
      ...
      <div className="flex items-center gap-5">
        ...
        <span className="text-blue-900/30 text-xs">&bull;</span>
